...
module.exports = class PackageReader {
  ...
  /**
   * Get prefix with stage config
   */
  getPrefixWithStage() {
    return this.getSection('secretNaming')['prefixWithStage']; 
  }

  /**
   * Get prefix separator
   */
  getPrefixSeparator() {
    return this.getSection('secretNaming')['prefixSeparator']; 
  }
};
